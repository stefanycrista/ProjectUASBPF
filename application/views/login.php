  ...
  <div class="container sm:px-10">
    <div class="block xl:grid grid-cols-2 gap-4">
      ...
      <div class="hidden xl:flex flex-col min-h-screen">
        ...
        <div class="my-auto">
          <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="<?= site_url('asset') ?>/admin/dist/images/bg_tio.png">
          <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Selamat Datang di website Tio Accesories</div>
        </div>
      </div>
      <!-- END: Login Info -->
      <!-- BEGIN: Login Form -->
